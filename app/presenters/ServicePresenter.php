    ...
    public function actionTelfa() {
        ...
        if( empty($json->hangup) ){
            ...
            if( empty($pokracovani) ){
                ...
                if ($found) {
                    $a = array( 'action' => 'read', 'female' => 'true', 'text_to_speak' =>  'Ahoj soutěžící, právě jsi úspěšně aktivoval svůj účet v soutěži s Piráty do Evropy! Komunikace v soutěži probíhá prioritně přes tvůj soutěžní email, kde se mimo jiné dozvíš, jak si pojistit vítězství ve svém soutěžním okrsku. Už teď bys měl mít ve své schránce vzkaz od Pirátů. Pokud tam není, zkontroluj, jestli není ve spamu. Pokud ani tam email není, napiš nám na soutež zavináč piráti tečka cé zet. Jestli chceš, můžeš si na webu objednat Balíček soutěžícího za 190 Kč, který obsahuje mimo jiné soutěžní tričko! Hodně úspěchů v soutěži s Piráty do Evropy!', 'pokracovani' => '2' );
                } else {
                    $a = array( 'action' => 'read', 'female' => 'true', 'text_to_speak' => ' Ahoj soutěžící, vítej v soutěži s Piráty do Evropy. Bohužel, telefon, ze kterého voláš, nesouhlasí s číslem telefonu zaregistrovaným v soutěži. Pokus ses přepsal, zaregistruj se, prosím, znovu a opět nás prozvoň, případně zavolej z telefonního čísla, které jsi uvedl v soutěžní registraci. Pokud si s tímhle nevíš rady, zavolej na kontaktní číslo XXX XXX XXX. Budeme se těšit.', 'pokracovani' => '2' );
                }
