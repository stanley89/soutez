    ...
    public function actionTelfa() {
        ...
        if( empty($json->hangup) ){
            ...
            if( empty($pokracovani) ){
                ...
                if ($found) {
                    $a = array( 'action' => 'read', 'female' => 'true', 'text_to_speak' =>  'Ahoj soutěžící, vítej na bezplatné lince soutěže s Piráty do Evropy. Právě jsi úspěšně aktivoval svůj účet v soutěži. Komunikace v soutěži probíhá hlavně přes ímejl. Už teď bys měl mít ve své schránce vzkaz od Pirátů, kde se mimo jiné dozvíš, jak si pojistit vítězství ve svém soutěžním okrsku. Pokud tam není, zkontroluj, jestli není ve spemu. Pokud ani tam ímejl není, napiš nám na soutež zavináč piráti tečka cé zet. Hodně úspěchů v soutěži s Piráty do Evropy!', 'pokracovani' => '2' );
                } else {
                    $a = array( 'action' => 'read', 'female' => 'true', 'text_to_speak' => ' Ahoj soutěžící, vítej na bezplatné lince soutěže s Piráty do Evropy. Bohužel, telefon, ze kterého voláš, nesouhlasí s číslem telefonu zaregistrovaným v soutěži. Pokud ses přepsal, zaregistruj se prosím znovu a opět nás prozvoň, případně zavolej z telefonního čísla, které jsi uvedl v soutěžní registraci. Pokud si s tímhle nevíš rady, napiš nám na soutež zavináč piráti tečka cé zet. Budeme se těšit.', 'pokracovani' => '2' );
                }
